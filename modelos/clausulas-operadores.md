---
title: "Cláusulas para contratos com operadores"
nav_order: 1
parent: "Modelos e orientações"
permalink: /modelos/clausulas-operadores/
...
> ⚠️ **Atenção**
>
> O texto abaixo é um **modelo de partida para adaptar** — não é um contrato pronto nem aconselhamento jurídico. Ajuste à sua realidade e ao serviço contratado, e **submeta a um profissional jurídico** antes de assinar. Veja o [Aviso legal](/disclaimer/).
...
> ✅ **Boas práticas**
>
> - Mantenha uma **lista dos seus operadores** (quem são, que dados acessam, para quê) — isso conversa direto com o seu [Inventário (ROPA)](/modulos/inventario-ropa/).
...
- [Bases legais (com exemplos)](/bases-legais/)
- [Inventário (ROPA)](/modulos/inventario-ropa/)

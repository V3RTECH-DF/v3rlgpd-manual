...
permalink: /modelos/transferencia-internacional/
...
> ⚠️ **Atenção**
>
> Material de **referência**, não aconselhamento. A adequação da sua transferência deve ser avaliada com apoio jurídico. Veja o [Aviso legal](/disclaimer/).
...
2. **Registre** isso no [Inventário (ROPA)](/modulos/inventario-ropa/).
...
- [Cláusulas para contratos com operadores](/modelos/clausulas-operadores/)

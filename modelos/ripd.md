---
title: "Relatório de Impacto (RIPD): quando fazer"
nav_order: 6
parent: "Modelos e orientações"
permalink: /modelos/ripd/
...
> ⚠️ **Atenção**
>
> Material de **referência**. A necessidade e a profundidade de um RIPD dependem do seu caso e devem ser avaliadas com apoio jurídico. Veja o [Aviso legal](/disclaimer/).
...
> - Reaproveite o que já está no [Inventário (ROPA)](/modulos/inventario-ropa/).

## Relacionado

- [Teste de Legítimo Interesse (LIA)](/modelos/teste-legitimo-interesse/)
- [Dados sensíveis](/modelos/dados-sensiveis/)
